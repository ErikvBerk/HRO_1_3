...
namespace app
{
    ...
    public class Game1 : Game
    {
        ...
        List<Texture2D> List_graphs = new List<Texture2D>();
        ...
        protected override void LoadContent()
        {
            ...
            List_Wijken.Add("Ijsselmonde"); //5
            List_Wijken.Add("Kralingen-Crooswijk"); //6
            List_Wijken.Add("Noord"); //7
            List_Wijken.Add("Overschie"); //8
            List_Wijken.Add("Prins-Alexander"); //9

            List_graphs.Add(this.Content.Load<Texture2D>("Centrum diagram")); //0
            List_graphs.Add(this.Content.Load<Texture2D>("Charlois diagram")); //1
            List_graphs.Add(this.Content.Load<Texture2D>("Delftshaven diagram")); //2
            List_graphs.Add(this.Content.Load<Texture2D>("Feyenoord diagram")); //3
            List_graphs.Add(this.Content.Load<Texture2D>("Hillegersberg-Schiebroek diagram")); //4
            List_graphs.Add(this.Content.Load<Texture2D>("Ijselmonde diagram")); //5
            List_graphs.Add(this.Content.Load<Texture2D>("Kralingen-Crooswijk diagram")); //6
            List_graphs.Add(this.Content.Load<Texture2D>("Noord diagram")); //7
            List_graphs.Add(this.Content.Load<Texture2D>("Overschie diagram")); //8
            List_graphs.Add(this.Content.Load<Texture2D>("Prins-Alexander diagram")); //9
            ...
            //create app instance
            app = new BaseApp(basemap, List_wijk_images, Font, rect, rect_info, List_Wijken, legenda, small_rect, List_graphs);
        }
