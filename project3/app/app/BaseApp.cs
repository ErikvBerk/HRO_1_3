...
namespace app
{
    class BaseApp
    {
        ...
        public BaseApp(Texture2D background, List<Texture2D> List_wijk_image, SpriteFont Font, Texture2D rect, Texture2D rect_info, List<string> list_names, Texture2D legenda, Texture2D small_rect, List<Texture2D> list_graphs)
        {
            ...
            while(counter2 < 10)
            {
                List_Locations.Add(new Location(List_names[counter2], List_names[counter2], List_wijk_image[counter2], List_Buttons[counter2], Budget, rect_info, Font, small_rect, list_graphs[counter2]));
                counter2++;
            }
        }
